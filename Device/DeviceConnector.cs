    ...
    public class DeviceConnector 
    {
        ...
        public  void openPort()
        {
           try
           {
            ...
            _serialPort.PortName = "COM6 ";//static port given here
        ...
        {
            string wri="DUPLICATE";
               try
                {
                    //string text1 = File.ReadAllText("E:\\inp.txt");
                    //textBox1.Text = text1;
                    string jsonProfile = "{ \"CHARGE\": \"987\", 'DISCHARGE': '654' }";
                    dynamic stuff = JObject.Parse(jsonProfile);
                    //jinp = textBox1.Text;
                    Console.WriteLine(stuff[jinp]);
                    string ch = (string)stuff[jinp];
                    _serialPort.WriteLine(ch);
